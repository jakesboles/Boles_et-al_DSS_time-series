#This script uses the anRichment package to infer biological function for each module
#This script will also generate the horizontal bar charts displaying these results
